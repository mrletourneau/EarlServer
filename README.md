...
Simply run `./gradlew build`. The resultant distributable will be located in `app/build/distributions`. To start Earl, simply run `bin/earl` from the root of the extracted distributable bundle.
